  ...
  return (
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis dataKey="name" tickLine={false} style={{fontSize:"12px"}}/>
          <YAxis yAxisId="left" tickLine={false} style={{fontSize:"12px"}} axisLine={false} domain={[8000,23000]} />
          <YAxis yAxisId="right" orientation='right' tickLine={false} style={{fontSize:"12px"}} axisLine={false} domain={[8000,23000]} />
          <Tooltip />
          <Legend
              height={20}
              wrapperStyle={{
